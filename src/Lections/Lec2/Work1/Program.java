 ...
 *
 *   3. Ученик средней школы, содержащий перегрузки методов базового класса, выводящие на экран фразы "Я играю в
 *   Minecraft" и "Ненавижу школу" соответственно.
 *
 ...
 * происходить вывод всей информации о школьнике, так же реализовать конструкторы, принемающие все поля.
